...
- A file is already managed locally: use `repo upgrade --no-overwrite` and review the diff.
- Tooling is split across loaders: resolve the loader first, then rerun the diagnosis.
