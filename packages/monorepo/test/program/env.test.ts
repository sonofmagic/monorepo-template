...
function createEnvPaths() {
  return {
    ...
    paths: {
      ...
      repoctlConfigs: [{ path: '/repo/repoctl.config.ts', relativePath: 'repoctl.config.ts', exists: false }],
      legacyConfig: { path: '/repo/monorepo.config.ts', relativePath: 'monorepo.config.ts', exists: false },
      legacyConfigs: [{ path: '/repo/monorepo.config.ts', relativePath: 'monorepo.config.ts', exists: false }],
